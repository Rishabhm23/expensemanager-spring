...
public class IncomeDTO {
	...
	public IncomeDTO(Long id, String name, String icon, String categoryName, Long categoryId, LocalDate date,
	...
	public String toString() {
		return "IncomeDTO [id=" + id + ", name=" + name + ", icon=" + icon + ", categoryName=" + categoryName
